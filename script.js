...

{
    ...
    let a = prompt(`Какое число вам неоходимо найти в числовой последовательности`, `5`);
    let n = prompt(`Введите любую числовую последовательность: `, `7646546546564`);
    ...
    console.log(`Число ${a} в числовой последовательности ${n} встречается ` + counter + ` раз(а)`);
